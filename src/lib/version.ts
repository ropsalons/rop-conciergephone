...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-04',
    time: '10:35 AM ET',
    title: 'Boulevard hours: auto-refresh nightly + a Refresh button',
    changes: [
      'Boulevard scheduled/booked hours now refresh themselves every night automatically — server-side, no computer or bot needed.',
      'Added a “Refresh now” button on the Stylists tab so a manager can pull the latest Boulevard hours on demand.',
    ],
  },
  {
    version: '1.54.1',
