...
const TOOLS = [
  ...
  { name: 'send_direct_message', action: 'send_dm', description: 'Send a direct message to a person by their email (requires DM permission).',
    schema: { type: 'object', required: ['to_email', 'text'], properties: { to_email: { type: 'string' }, text: { type: 'string' } } } },
